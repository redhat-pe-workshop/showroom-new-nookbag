...
include::../../partials/login-pe-full.adoc[]
...
. Refresh the https://openshift-gitops-server-openshift-gitops.{openshift_cluster_ingress_domain}[`backstage` Application, window="argo"] to rollout the new {product_name_rhdh} configuration.
include::../../partials/login-argo.adoc[]
